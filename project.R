...
colclasses = c("numeric","character","numeric","numeric","character",
...
pcakeep = c("roll_belt","pitch_belt","yaw_belt","total_accel_belt",
    ...
    "skewness_pitch_forearm","max_roll_forearm",
    "max_picth_forearm","max_yaw_forearm","min_roll_forearm",
    "min_pitch_forearm","min_yaw_forearm","amplitude_roll_forearm",
    "amplitude_pitch_forearm","total_accel_forearm",
...
train1 <- predict(preProc1, pcaframe)
...
qplot(pcadecomp$x[,1], pcadecomp$x[,2], pch=plotshape[, "classe2"], col = plotcolor[,"classe2"])
...
modelFit <- train(pmlsummary2$numclass ~ .,method="gbm",data=pmlsummary)
